<?php
    ...
    function newscover_front_page_main_section_2() {
...
add_action('newscover_action_front_page_main_section_2', 'newscover_front_page_main_section_2', 40);
