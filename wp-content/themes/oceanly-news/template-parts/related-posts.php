...
$oceanly_posts = Oceanly_News_Related_Posts::options_query();
if ( ! $oceanly_posts ) {
	return;
}
...
<div class="ol-related-posts">
	<?php if ( '' !== $oceanly_posts['options']['title'] ) { ?>
	<h2 class="ol-related-posts-title"><?php echo esc_html( $oceanly_posts['options']['title'] ); ?></h2>
	<?php } ?>
